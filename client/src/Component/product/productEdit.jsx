...
class ProductEdit extends Component {
    ...
    handleSubmit = () => {
        ...
        const { name, price, desription, category, subcategory, imagespath } = this.state;
        const product = { name, price, desription, category, subcategory, imagespath }
        const headers = { Authorization: this.props.token }
        console.log(this.props.token)
        axios.put(`/api/product/${id}`, product, { headers })
            .then(res => {
