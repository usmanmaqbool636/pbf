...
import Edit from './Component/product/productEdit';
  ...
  render() {
    ...
    return (
      <Switch>
        ...
        {
          (user.role === 1 || user.role === 2) && <Route exact path="/addproduct" component={AddProduct} />
        }
...
export default withRouter(connect(mapDispatchTopProps, { setUser })(App));
